...
add wave -noupdate -format Literal -radix hexadecimal /c2sb_soc_tb/uut/mcu/cpu/ie_reg
...
add wave -noupdate -format Literal -radix hexadecimal /c2sb_soc_tb/uut/mcu/cpu/sfr_rd_internal
add wave -noupdate -color Pink -format Literal /c2sb_soc_tb/uut/mcu/cpu/ps
add wave -noupdate -divider Internal
add wave -noupdate -format Literal -radix hexadecimal /c2sb_soc_tb/uut/mcu/cpu/iram_sfr_rd
...
add wave -noupdate -group Datapath -expand -group Inputs
...
update
WaveRestoreZoom {408913770 ps} {409099276 ps}
